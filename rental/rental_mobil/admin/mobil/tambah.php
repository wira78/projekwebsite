                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group row">
                                ...
                                <input type="text" class="form-control col-sm-9" name="platnomor" placeholder="Isi No Plat">
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <input type="text" class="form-control col-sm-9" name="harga_rental" placeholder="Isi Harga">
                            </div>
